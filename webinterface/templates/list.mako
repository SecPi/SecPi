...
%>
		...
		% for obj in data:
			...
			% endfor
				<td><a href="delete?id=${obj.id}" onclick="return confirm('Are you sure?')"><img src="/static/img/icons/minus.png" alt="delete" title="delete" /></a><a href="update?id=${obj.id}"><img src="/static/img/icons/edit.png" alt="edit" title="edit" /></a></td>
			</tr>
		% endfor
	</table>
% else:
