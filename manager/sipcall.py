...
from pycall import CallFile, Call, Context, Application
...
class SipCall(Notifier):
	...
	def __init__(self, id, params):
		...
		try:
			...
			logging.error("SipCall: Error while trying to initialize notifier, it seems there is a config parameter missing: %s" % ke)
			self.corrupted = True
			return
